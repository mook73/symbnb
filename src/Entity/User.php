...
class User implements UserInterface
{
    ...
    // Ajout de cette propriété afin de pouvoir afficher le formulaire d'inscription sans bug
    // Pas d'annotation ORM car je n'ai pas ce champ ds ma BDD
    // ("@ORM..." permet de faire le lien entre ma table et mon code en PHP)
    /**
    ...
    public function getRoles() {
        // userRoles est une classe ArrayCollection (tableau en plus puissant)
        // toArray() permet de transformer un ArrayCollection en array classique
